...
public class RequestUtil {
    ...
    public static String getRequestPath(HttpServletRequest request) {
        return Optional.ofNullable(BracketSession.getUrlPath()).orElse(doGetRequestPath(request));
    }
    ...
    public static HttpMethod getRequestType(HttpServletRequest request) {
        return Optional.ofNullable(BracketSession.getRequestType()).orElse(doGetRequestType(request));
    }
    ...
    public static HttpMethod doGetRequestType(HttpServletRequest request) {
        ...
        //设置缓存
        BracketSession.getRequestProfile().setRequestType(httpMethod);
        return httpMethod;
    }
    ...
    public static Map<String, String> doGetRequestHeader(HttpServletRequest request) {
        ...
        //设置缓存
        BracketSession.getRequestProfile().setHeader(requestHeaderMap);
    ...
    public static void checkRequestParam(Object[] args) {
        for (Object arg : args) {
            if (arg instanceof BeanPropertyBindingResult && ((BeanPropertyBindingResult) arg).hasErrors()) {
                ...
                throw new BracketBusinessException(errMsg);
            }
        }
    }
    ...
    public static String doGetRequestParam(HttpServletRequest request) {
        ...
        //设置缓存
        BracketSession.getRequestProfile().setRequestParam(requestParam);
        return requestParam;
    }
    ...
    public static String getRequestParam(Object[] args, HttpServletRequest request) {
        return Optional.ofNullable(BracketSession.getRequestParam()).orElse(doGetRequestParam(args, request));
    }
    ...
    public static String doGetRequestParam(Object[] args, HttpServletRequest request) {
        ...
        //设置缓存
        BracketSession.setRequestParam(requestParam);
        return requestParam;
    }
