package com.mantis.brac.common.tools;
...
public class PackageTools {
    ...
    public static Set<String> findPackageClass(String scanPackages) {
        if (StringUtil.strEmpty(scanPackages)) {
            ...
            while (true) {
                ...
                } while (StringUtil.strEmpty(basePackage));
    ...
    private static Set<String> checkPackage(String scanPackages) {
        if (StringUtil.strEmpty(scanPackages)) {
            ...
            for (int var4 = 0; var4 < var3; ++var4) {
                ...
                if (!StringUtil.strEmpty(pInArr) && !pInArr.equals(".") && !pInArr.startsWith(".")) {
                    if (pInArr.endsWith(".")) {
